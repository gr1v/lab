...
if __name__ == "__main__":
    ...
    print(f"\nИтог: вес = {total_weight}, ценность = {total_value}")5
...
Введите вместимость рюкзака: 13
Введите количество муравьёв: 6
Введите количество итераций: 5

============================================================
Введенные данные:
Количество предметов: 5
Веса предметов: [5.0, 8.0, 6.0, 8.0, 4.0]
Ценности предметов: [4.0, 2.0, 9.0, 9.0, 3.0]
Вместимость рюкзака: 13.0
Количество муравьёв: 6
Количество итераций: 5

Запуск алгоритма муравьиной колонии...
Итерация 0: лучшая ценность = 13.0

============================================================
РЕЗУЛЬТАТЫ:
Выбранные предметы (индексы): [0, 2]
Выбранные предметы (номера): [1, 3]
Общая ценность: 13.0
Общий вес: 11.0
Вместимость рюкзака: 13.0

Детали выбранных предметов:
  Предмет 1: вес = 5.0, ценность = 4.0
  Предмет 3: вес = 6.0, ценность = 9.0

Итог: вес = 11.0, ценность = 13.0
